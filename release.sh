...
PROJECT=cloudflinger-com-prod
LOCAL_IMAGE_NAME="openvpn-operator"
REMOTE_IMAGE_NAME="gcr.io/${PROJECT}/${LOCAL_IMAGE_NAME}"
...
VERSION=$(cat VERSION)
cp ../../chart-releases/openvpn-$VERSION.tgz ./

echo "Building version ${VERSION}."

docker build -t $LOCAL_IMAGE_NAME --build-arg HELM_CHART=openvpn-$VERSION.tgz --build-arg API_VERSION=brain.cloudflinger.com/v1alpha1 --build-arg KIND=Openvpn .
